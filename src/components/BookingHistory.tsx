...
import {
    ...
    BookOpen, Loader2, RefreshCw, User, Building, BookMarked
} from "lucide-react";
            ...
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Просмотр и управление вашими бронированиями аудиторий
                        </p>
                    </div>
                ...
                <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab}>
                    <TabsList className="mb-4">
                        ...
                        <TabsTrigger value="approved">Подтвержденные</TabsTrigger>
                            ...
                            <CardContent className="py-10">
                                <div className="text-center">
                                    ...
                                    <p className="text-muted-foreground max-w-sm mx-auto mb-6">
                                        {activeTab === "all"
                                            ? "У вас пока нет бронирований аудиторий. Создайте новое бронирование, чтобы оно появилось в этом списке."
                                            : "В данной категории нет бронирований."}
                                    </p>
